...
st.image("icon.jpeg", width=85)
st.title("Car Damage Detection")
st.subheader("Yolo-NAS + SAM")
...
st.write(
    ...
    Hi 👋, I'm **:red[Shubham Shankar]**, and welcome to my **:green[Car Damage Detection Application]**! :rocket: This program makes use of **:blue[YOLO-NAS]** and **:orange[SAM]** model, 
...
if image_file is not None:
    ...
    if st.button('RUN'):
        ...
        # define class name
        class_names = ['crack_and_hole', 'medium_deformation', 'severe_deformation', 'severe_scratch', 'slight_deformation', 'slight_scratch', 'windshield_damage']
